package com.lamp.allUtils.impl;
...
import com.lamp.allUtils.OrderQueryParam;
import com.lamp.allUtils.web.param.QueryParam;
...
public abstract class BaseServiceImpl<M extends BaseMapper<T>, T> extends ServiceImpl<M, T> implements BaseService<T> {
    ...
    protected void getPage2(Pageable pageable) {
        String order=null;
        if(pageable.getSort()!=null){
            order= pageable.getSort().toString();
            order=order.replace(":","");
